...
| Status | Asset | Target Path | Purpose | Notes |
|---|---|---|---|---|
| partial | P0/P1 zone plates — nine `awakening_*_environment` families | `custodian/content/levels/awakening/<zone>/<owner>_{underlay,foreground}_<WxH>.png` | Replace each section's blockout presentation without changing spatial authority. | Underlays for Crèche, Ambulatory, Attestation, Locker Reliquary, and Dust Lung are ingested. Gate Plaza (07) and Custodian Approach (08) now have both underlay and foreground ingested. Remaining: foregrounds for zones 01–05, and both plates for Undergate (06) and Late Service (09). Exact remaining canvases are defined by the family contracts. |
