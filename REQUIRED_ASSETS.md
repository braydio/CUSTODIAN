...
| Status | Asset | Target Path | Purpose | Notes |
|---|---|---|---|---|
| partial | P0/P1 zone plates — nine `awakening_*_environment` families | `custodian/content/levels/awakening/<zone>/<owner>_{underlay,foreground}_<WxH>.png` | Replace each section's blockout presentation without changing spatial authority. | Underlays for Crèche, Ambulatory, Attestation, Locker Reliquary, and Dust Lung are ingested and bound. Their foregrounds and all plates for zones 06–09 remain needed. Exact remaining canvases are defined by the family contracts. |
