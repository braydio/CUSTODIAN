...
| Status | Asset | Target Path | Purpose | Notes |
|---|---|---|---|---|
| partial | P0/P1 zone plates — nine `awakening_*_environment` families | `custodian/content/levels/awakening/<zone>/<owner>_{underlay,foreground}_<WxH>.png` | Replace each section's blockout presentation without changing spatial authority. | Underlays for Crèche, Ambulatory, Attestation, Locker Reliquary, and Dust Lung are ingested. Undergate (06), Gate Plaza (07), Custodian Approach (08), and Late Service (09) now have both underlay and foreground ingested. Remaining foregrounds for zones 01–05 are still tracked by their family contracts. |
