...
| Status | Asset | Target Path | Purpose | Notes |
|---|---|---|---|---|
| partial | Forlorn-Ritualant NPC runtime sprites | `custodian/content/sprites/enemies/enemy_forlorn_ritualant/runtime/body/` | Complete readable locomotion, reaction, and encounter-defining action animation on the live 128×128 contract. | Idle, hostile-idle, four-frame rise, Pin Strike, and Thread Pull are live. Ninth Answer and Orra Comes Late mechanics are live with explicit temporary Thread Pull visual fallback. Still needed: `enemy_forlorn_ritualant__body__ninth_answer__s__10f__128.png` (1280×128), `enemy_forlorn_ritualant__body__orra_late__s__8f__128.png` (1024×128), directional walk/drag, turning, reactions, and the eight-frame rise. |
| partial | Forlorn-Ritualant death/dissolve sprites | `custodian/content/sprites/enemies/enemy_forlorn_ritualant/runtime/body/enemy_forlorn_ritualant__body__dissolve__s__10f__128.png`, `custodian/content/sprites/enemies/enemy_forlorn_ritualant/runtime/body/enemy_forlorn_ritualant__body__death_violent__s__8f__128.png` | Let nonviolent dissolve and violent defeat resolve with authored ritual animation. | A one-frame south-facing dissolve exists; nonviolent resolution times it before removal, while violent defeat still has no authored death sequence. |
