...
Also note: your working tree is dirty on `main`, mostly because of operator/parry/block/inventory/fabrication-related work, plus a new `design/PROCGEN_CORRECTIONS.md`. That means Codex should branch before touching worldgen.
