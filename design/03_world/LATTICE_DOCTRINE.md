...
**Related Docs:** `design/03_content/GAME_PROTOCOLS_AND_WORLD_LORE.md`, `design/03_architecture/HUB_SYSTEM_META_PROGRESSION.md`, `design/03_architecture/CAMPAIGN_FLOW_AND_GAME_LOOP.md`, `design/03_content/PROCEDURAL_LORE_GENERATION.md`  
