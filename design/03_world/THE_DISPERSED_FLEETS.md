...
**Project:** CUSTODIAN  
**Created:** 2026-06-20  
**Status:** reference / design-shaping  
**Last Updated:** 2026-06-20  
**Canon Tier:** Tier 3 — emerging canon, open for elaboration  
**Related Docs:** `design/03_world/GAME_PROTOCOLS_AND_WORLD_LORE.md`, `design/03_world/LATTICE_DOCTRINE.md`, `design/03_world/THE_ASH-BELL_CONTINUITY.md`, `design/03_world/FACTION_PROFILES.md`
...
These were not small scout craft. They were the first large instruments of human authority to confront the expanding wound. Expeditionary fleets assembled from the combined naval and security forces of every major power: federal patrol wings, corporate security battlegroups, colonial militia task forces, independent-system treaty vessels. Whatever could be mustered, whatever could navigate the degrading transit lanes, was dispatched along the collapsing meridian.

Not one of them ever returned.

No wreckage. No emergency beacon. No faint scrambled burst from a dying comms array. The fleets transited their last known coordinates and simply stopped existing in any observable frame. Every broadcast frequency that had once carried a ship's voice — call signs, tactical nets, internal chatter, final desperate distress calls — went silent simultaneously and never spoke again.
...
### Potential Revelation Pathways

These are design hooks, not committed plot. They exist to be chosen among or contradicted later.
...
- Wreckage or anomalous debris fields from the pre-Dispersal mobilization — ships that never made it to the departure point, depots abandoned mid-provisioning, comm relays that still cycle through the last dispatch roster.
- Archive entries that cut off mid-sentence, or refer to fleet movements that no surviving record can confirm.
- Terminal fragments: partial manifests, crew rosters, last recorded orders.

### Faction Design (if Path B)
...
- Did the Dispersed Fleets include Custodians? (If yes, this reframes the Custodian project as having been present at the first wound. If no, the Custodian project began *after* the first catastrophe was already known.)
- Are there living descendants of fleet personnel who were *not* dispersed — families, support crews, shore establishments who waited for a return that never came? What became of them?
- Is the destination of the Dispersed Fleets the same place the Custodian is already trying to reach, or a different axis entirely?
- What would it mean to find a broadcast from one of the lost ships — arriving now, decades late, still carrying the voice of a commander reporting conditions that no longer exist?

---

*This document is a design-shaping reference, not an implementation target. It exists to seed environmental storytelling, faction concepts, and revelation architecture. It may be superseded, contradicted, or deepened as the setting evolves.*
