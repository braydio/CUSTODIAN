...
# CUSTODIAN Encounter Spec: The Forlorn-Ritualant

Internal continuity tag: `ash_bell`
Player-facing continuity name: **never shown**
Encounter name: **The Forlorn-Ritualant**
...
A kneeling drifter, the **Forlorn-Ritualant**, guards a bronze clapper from a bell that does not exist. They speak as if remembering a sacred disaster: the west gate was shut, the Ninth Bell rang, the Custodians obeyed, and Saint Orra — the Unarrived Saint — came too late.
...
```txt
custodian/game/world/events/ash_bell/forlorn_ritualant_event.tscn
```
...
```txt
custodian/content/events/ash_bell/forlorn_ritualant_dialogue.json
custodian/content/events/ash_bell/forlorn_ritualant_event.json
...
# 5. Forlorn-Ritualant Character Design
...
```txt
Create a top-down 3/4 pixel art humanoid NPC for CUSTODIAN: The Forlorn-Ritualant. A gaunt kneeling figure in funeral-black layered robes with an ash-gray mantle, white ritual thread wrapped around wrists/fingers/throat, small rusted bell fragments tied into the clothing, torn black banner cloth at the waist, soot veil over the face, pale ash-glowing eyes. Dark Souls / Elden Ring inspired, mournful religious horror, readable at 32–64 px scale, transparent background, strong silhouette, muted ash/black/bronze palette.
```

## Runtime sprites

```txt
custodian/content/sprites/npcs/ash_bell/forlorn_ritualant/idle_kneel_south.png
custodian/content/sprites/npcs/ash_bell/forlorn_ritualant/idle_kneel_east.png
custodian/content/sprites/npcs/ash_bell/forlorn_ritualant/rise_south.png
custodian/content/sprites/npcs/ash_bell/forlorn_ritualant/rise_east.png
custodian/content/sprites/npcs/ash_bell/forlorn_ritualant/walk_south.png
custodian/content/sprites/npcs/ash_bell/forlorn_ritualant/attack_clapper_south.png
custodian/content/sprites/npcs/ash_bell/forlorn_ritualant/cast_toll_south.png
custodian/content/sprites/npcs/ash_bell/forlorn_ritualant/death_unthreading.png
```
...
Every major Forlorn-Ritualant cast increments it.
