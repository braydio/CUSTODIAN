...
This index tracks non-runtime ideas only. It does not replace active implementation specs.
...
| Card | Status | Priority | Maturity |
|---|---|---|---|
| `tooling/developer_observatory.md` | candidate | P0 | system |
| `ai/director_memory.md` | candidate | P1 | system |
| `world/world_state_graph.md` | candidate | P0 | system |
| `world/persistent_world_history.md` | candidate | P0 | system |
...
| `simulation/interest_management.md` | triaged | P1 | system |
| `simulation/navigation_combat_heatmaps.md` | candidate | P1 | system |
...
Wave 3 (2026-07-08) — Technical Systems — all 10 cards disseminated into category folders above. Staging receipt at `Cards-Wave-3/`.
