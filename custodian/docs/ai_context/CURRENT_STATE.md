...
- Debug console access: DevConsole addon (autoloaded at `/root/DevConsole`) toggled with `~` (tilde/backtick) key; custom commands registered: `debug_hud`, `show_cognitive`, `test_spawn`, `ui_status`.
