...
SOUTH is now 14/14 alpha-approved through the two regenerated replacement
batches. NORTH has three alpha-approved replacements (`ground_idle`,
`ground_walk`, `bite_attack`); `perch_idle`, `hurt`, and `death` remain on the
temporary baseline. The
