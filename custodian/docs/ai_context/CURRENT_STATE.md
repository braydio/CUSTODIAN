...
- Awakening lighting is now native and authored: `World/Lighting` owns one `CanvasModulate`, `DirectionalLight2D`, and `WorldLightingDirector`, with a neutral baseline for sections 01–04. Overlapping Dust Lung, south threshold, Undergate core, and north threshold zones create the first flashlight-dominant environment. Zone 06 is widened to `Rect2(-704, -4864, 1408, 1088)` and shaped as a narrow service throat, 1024px Mechanism Nave, west Register gallery, and north gate throat; its future environment plates are 1536×1216 and remain missing.
