...
- Procgen world progression now layers a deterministic distance-band profile over generated contract maps. The profile drives gradual outward ascent metadata, style/faction sampling, claimable ambient activity anchors, and metadata-only environmental story-room candidates without replacing the underlying generator or moving simulation authority into presentation markers.
