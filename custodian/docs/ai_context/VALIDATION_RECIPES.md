...
env HOME=/tmp/custodian-godot-home godot --headless --path . --script res://tools/validation/operator_melee_locomotion_socket_smoke.gd
...
godot --headless --path . --script res://tools/validation/enemy_grunt_behavior_presentation_smoke.gd
...
The ocean TileSet smoke also validates all 20 shoreline foam sources (straight,
