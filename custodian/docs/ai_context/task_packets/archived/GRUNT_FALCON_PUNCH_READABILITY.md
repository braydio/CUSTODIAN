...
- Acceptance: Falcon travel stops at a contact point, recovery never drifts forward, parry cancels all Falcon phases, damaging hits invoke Operator impact, recent parry and occupied ally lanes block launch, and focused/current reaction smokes pass.
- Completed: Retuned the live grunt scene; added stop-short travel, contact and enemy separation, independent cooldown and deterministic cadence, recent-parry and ally-lane gates, hard parry cancellation, dedicated Operator impact feedback, focused smoke coverage, and active documentation updates.
