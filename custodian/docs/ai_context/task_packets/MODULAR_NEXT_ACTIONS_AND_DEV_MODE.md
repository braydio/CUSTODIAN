...
- Status: `complete`
- Authority: `design/02_features/debug_ui/DEV_MODE_SYSTEM.md`, `design/02_features/debug_ui/DEVELOPER_OBSERVATORY_SYSTEM.md`, `custodian/tools/validation/contracts/operator_animation_core.json`
