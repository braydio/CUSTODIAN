...
- Calm locomotion asset job: `job_20260823T000321Z_a22e98d4`; the authored walk replaced its canonical E/W targets in place, the already-present E unarmed-run was deduplicated, and V2 generated the W mirror. Patrol/ambient movement selects walk, faster non-aggro investigation/objective travel selects unarmed run, and aggro/escape retains armed run; BSM profile speed remains authoritative.
