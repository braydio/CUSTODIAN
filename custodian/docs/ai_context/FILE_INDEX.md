...
- `custodian/content/levels/sundered_keep/sundered_keep_front_gate_large.json` — data source for the active `112x80` Sundered Keep front-gate layout, including widened/lengthened lower causeway shore, raised bridge elevation regions, side stair transitions, directional shore/ocean causeway surface edge placement, prefab-aligned gatehouse blockers with visible placeholder wall art, Return Mooring/key alcoves, gatehouse, courtyard, semantic labyrinth partition blockers, service/rampart branches, Great Hall front with a right-turn post-door carpet/wall hallway, ocean/void-edge placeholder readability stamps, blockers, markers, and interactables
...
- `custodian/tools/validation/sundered_keep_large_layout_smoke.gd` — validates the large JSON layout source, minimum map size, raised bridge elevation/ramp/side-stair connectivity, absence of shore/ocean causeway edge tiles on the bridge deck, parapet collision/openings, placeholder labyrinth wall/void-edge stamp counts, semantic courtyard partition collision with the central lane open, prefab gatehouse placement and animation, Great Hall doorway animation/depth-sort attachment, right-turn Great Hall carpet/wall hallway collision, marine ambush spawn and dash body/FX readiness, pre-gate reachability, closed-gate route blocking, post-key gate opening, gate-open siege activation, objective damage/repair, defense turret creation, Great Hall door opening, and missing asset count
