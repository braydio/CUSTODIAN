...
- `custodian/game/actors/items/cognitive_pickup.gd` — pickup flow that increments `InventoryManager`, applies `CognitiveState`, and emits popup/log feedback
...
- `custodian/content/sprites/items/shrumb_drops/` — placeholder 32x32 pickup sprites for the three cognitive drops; replace with production art when available
