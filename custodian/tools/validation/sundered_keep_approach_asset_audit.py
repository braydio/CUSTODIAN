...
EXPECTED_SIZES = {
    ...
    "content/backgrounds/sundered_keep/approach/first_vista_base_storm_horizon.png": (2600, 1460),
    "content/backgrounds/sundered_keep/approach/fog/first_vista_reveal_veil.png": (2600, 720),
    "content/backgrounds/sundered_keep/distant_sundered_keep_landmark_v2.png": (1840, 854),
...
ALPHA_REQUIRED = {
    ...
    "content/backgrounds/sundered_keep/distant_sundered_keep_landmark_v2.png",
