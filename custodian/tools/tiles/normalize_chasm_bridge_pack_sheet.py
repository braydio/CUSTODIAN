...
CHASM_BRIDGE_TILES = [
    {
        "id": "chasm_void_32",
        "file": "chasm_void_32.png",
        "role": "chasm_void",
        "walkable": False,
        "traversal": "drop",
        "region_type": "terrain_chasm",
    },
    {
        "id": "chasm_edge_n_32",
        "file": "chasm_edge_n_32.png",
        "role": "chasm_edge",
        "edge": "north",
        "walkable": False,
        "traversal": "ledge",
    ...
    {
        "id": "chasm_outer_corner_ne_32",
        "file": "chasm_outer_corner_ne_32.png",
        "role": "chasm_outer_corner",
        "corner": "ne",
        "walkable": False,
        "traversal": "ledge",
    },
    {
        "id": "chasm_outer_corner_nw_32",
        "file": "chasm_outer_corner_nw_32.png",
        "role": "chasm_outer_corner",
        "corner": "nw",
        "walkable": False,
        "traversal": "ledge",
    ...
    {
        "id": "chasm_outer_corner_se_32",
        "file": "chasm_outer_corner_se_32.png",
        "role": "chasm_outer_corner",
        "corner": "se",
        "walkable": False,
        "traversal": "ledge",
    ...
    {
        "id": "chasm_outer_corner_sw_32",
        "file": "chasm_outer_corner_sw_32.png",
        "role": "chasm_outer_corner",
        "corner": "sw",
        "walkable": False,
        "traversal": "ledge",
    ...
    {
        "id": "chasm_inner_corner_ne_32",
        "file": "chasm_inner_corner_ne_32.png",
        "role": "chasm_inner_corner",
        "corner": "ne",
        "walkable": False,
        "traversal": "ledge",
    },
    {
        "id": "chasm_inner_corner_nw_32",
        "file": "chasm_inner_corner_nw_32.png",
        "role": "chasm_inner_corner",
        "corner": "nw",
        "walkable": False,
        "traversal": "ledge",
    ...
    {
        "id": "chasm_inner_corner_se_32",
        "file": "chasm_inner_corner_se_32.png",
        "role": "chasm_inner_corner",
        "corner": "se",
        "walkable": False,
        "traversal": "ledge",
    ...
    {
        "id": "chasm_inner_corner_sw_32",
        "file": "chasm_inner_corner_sw_32.png",
        "role": "chasm_inner_corner",
        "corner": "sw",
        "walkable": False,
        "traversal": "ledge",
    ...
    {
        "id": "collapsed_gap_32",
        "file": "collapsed_gap_32.png",
        "role": "collapsed_gap",
        "walkable": False,
        "traversal": "drop",
    },
    {
        "id": "broken_gap_edge_32",
        "file": "broken_gap_edge_32.png",
        "role": "broken_gap_edge",
        "walkable": False,
        "traversal": "ledge",
    },
    {
        "id": "bridge_stone_mid_horizontal_32",
        "file": "bridge_stone_mid_horizontal_32.png",
        "role": "bridge_mid",
        "orientation": "horizontal",
        "style": "stone",
        "walkable": True,
        "region_type": "terrain_bridge",
    },
    {
        "id": "bridge_stone_mid_vertical_32",
        "file": "bridge_stone_mid_vertical_32.png",
        "role": "bridge_mid",
    ...
    {
        "id": "bridge_stone_start_n_32",
        "file": "bridge_stone_start_n_32.png",
        "role": "bridge_start",
        "direction": "north",
        "style": "stone",
        "walkable": True,
    ...
    {
        "id": "bridge_stone_start_s_32",
        "file": "bridge_stone_start_s_32.png",
        "role": "bridge_start",
        "direction": "south",
        "style": "stone",
        "walkable": True,
    ...
    {
        "id": "bridge_stone_start_e_32",
        "file": "bridge_stone_start_e_32.png",
        "role": "bridge_start",
        "direction": "east",
        "style": "stone",
        "walkable": True,
    ...
    {
        "id": "bridge_stone_start_w_32",
        "file": "bridge_stone_start_w_32.png",
        "role": "bridge_start",
        "direction": "west",
        "style": "stone",
        "walkable": True,
    ...
    {
        "id": "bridge_metal_mid_horizontal_32",
        "file": "bridge_metal_mid_horizontal_32.png",
        "role": "bridge_mid",
        "orientation": "horizontal",
        "style": "metal",
        "walkable": True,
    ...
    {
        "id": "bridge_metal_mid_vertical_32",
        "file": "bridge_metal_mid_vertical_32.png",
        "role": "bridge_mid",
        "orientation": "vertical",
        "style": "metal",
        "walkable": True,
    ...
    {
        "id": "bridge_broken_segment_32",
        "file": "bridge_broken_segment_32.png",
        "role": "bridge_broken_segment",
        "walkable": True,
        "variant": "damaged",
    },
]
...
def alpha_mask(
    ...
    if merge_radius > 0:
        # MaxFilter size must be odd. This merges chains/rubble belonging to the same tile
        # without making black void pixels transparent or deleting them.
...
def write_manifest(manifest_path: Path, tiles: List[Dict]) -> None:
    manifest = {
        "id": "terrain_chasm_bridge_pack",
        "version": 1,
        "source_type": "ai_generated_source_sheet_component_sliced",
        "source_sheet": "res://content/tiles/terrain/source/generated/chasm_bridge/chasm_bridge_pack_ai_source.png",
        "normalized_source_dir": "res://content/tiles/terrain/source/generated/chasm_bridge/normalized_1024/",
        "preview_dir": "res://content/tiles/terrain/source/generated/chasm_bridge/previews_256/",
        ...
        "role": "chasm_and_controlled_crossing",
        "tiles": tiles,
    }
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Slice and normalize the chasm+bridge source sheet into runtime 32x32 tiles."
    )
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Path to chasm_bridge_pack_ai_source.png. Defaults to repo terrain source path.",
    )
    ...
    if sheet_path is None:
        sheet_path = (
            custodian_root
            / "content/tiles/terrain/source/generated/chasm_bridge/chasm_bridge_pack_ai_source.png"
        )
    ...
    normalized_dir = (
        custodian_root
        / "content/tiles/terrain/source/generated/chasm_bridge/normalized_1024"
    )
    preview_dir = (
        custodian_root
        / "content/tiles/terrain/source/generated/chasm_bridge/previews_256"
    )
    runtime_dir = custodian_root / "content/tiles/terrain/runtime/chasm_bridge"
    manifest_path = (
        custodian_root / "content/tiles/terrain/manifests/chasm_bridge_pack.game32.json"
    )

    report_dir = repo_root / "reports/terrain_pack_ingest"
    report_path = report_dir / "chasm_bridge_pack_normalize_report.md"
    debug_sheet_path = report_dir / "chasm_bridge_pack_detected_components.png"
    ...
    expected = len(CHASM_BRIDGE_TILES)
    ...
    report_lines = [
        "# Chasm + Bridge Pack Normalize Report",
        "",
    ...
    for index, (comp, tile_def) in enumerate(zip(ordered, CHASM_BRIDGE_TILES), start=1):
        tile_id = tile_def["id"]
        bbox = comp["bbox"]
    ...
    print()
    print("chasm bridge pack normalization complete")
    return 0
