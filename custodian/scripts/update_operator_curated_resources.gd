...
const BASE_WALK_SHEET := "res://assets/sprites/operator/runtime/animation_base/body/core_locomotion/walking_base.png"
const BASE_RUN_SHEET := "res://assets/sprites/operator/runtime/animation_base/body/core_locomotion/running_base.png"
const BASE_LIGHT_ATTACK_SHEET := "res://assets/sprites/operator/runtime/animation_base/body/melee/light_attack_base.png"
const BASE_FAST_ATTACK_RIGHT_SHEET := "res://assets/sprites/operator/runtime/animation_base/body/melee/fast_attack_right_base.png"
