...
@export var map_scene: PackedScene = preload("res://procgen/proc_gen_map.tscn")
...
@export var room_templates_path: String = "res://rooms/templates"
@export var room_graph_path: String = "res://rooms/graphs/default_compound.json"
