...
static func load_weapon_animations(weapon_id: String) -> Dictionary:
    var def_path := "res://content/sprites/weapons/%s/weapon_definition.json" % weapon_id
    ...
    for anim_name in def.animations:
        ...
        var full_path := "res://content/sprites/weapons/%s/%s" % [weapon_id, anim_data.file]
...
- `custodian/content/sprites/README.md` — Sprite overview
