...
def normalize_manifest(
    ...
    output_manifest_path = output_root / "road_piece_manifest.game32.json"
    ...
    new_manifest["asset_pack"] = f"{manifest.get('asset_pack', 'road_pieces')}_game32"
...
def main() -> None:
    ...
    print("Road piece normalization complete.")
