...
const BOUNDARY_SEGMENTS := [
	[Vector2(-167.2, 844.8), Vector2(-306.4, 789.5)],
	[Vector2(-306.4, 789.5), Vector2(-371.1, 705.2)],
	[Vector2(-371.1, 705.2), Vector2(-376.6, 665.1)],
	[Vector2(-376.6, 665.1), Vector2(-345.4, 611.9)],
	[Vector2(-345.4, 611.9), Vector2(-214.5, 515.6)],
	[Vector2(-214.5, 515.6), Vector2(-244.7, 304.4)],
	[Vector2(-244.7, 304.4), Vector2(-287.3, 246.9)],
	[Vector2(-287.3, 246.9), Vector2(-210.1, 149.7)],
	[Vector2(-210.1, 149.7), Vector2(-244.7, 90.0)],
	[Vector2(-244.7, 90.0), Vector2(-236.3, 39.7)],
	[Vector2(-236.3, 39.7), Vector2(-246.1, -2.3)],
	[Vector2(-246.1, -2.3), Vector2(-277.1, -23.3)],
	[Vector2(-277.1, -23.3), Vector2(-407.9, -199.7)],
	[Vector2(-407.9, -199.7), Vector2(-440.9, -164.1)],
	[Vector2(-440.9, -164.1), Vector2(-574.3, -251.4)],
	[Vector2(-574.3, -251.4), Vector2(-543.1, -287.0)],
	[Vector2(-543.1, -287.0), Vector2(-394.1, -321.4)],
	[Vector2(-394.1, -321.4), Vector2(-321.9, -323.4)],
	[Vector2(-321.9, -323.4), Vector2(-304.7, -314.1)],
	[Vector2(-304.7, -314.1), Vector2(-207.3, -433.1)],
	[Vector2(-207.3, -433.1), Vector2(-148.3, -441.7)],
	[Vector2(-148.3, -441.7), Vector2(-93.1, -425.9)],
	[Vector2(-93.1, -425.9), Vector2(-65.8, -427.7)],
	[Vector2(-65.8, -427.7), Vector2(-23.9, -433.0)],
	[Vector2(-23.9, -433.0), Vector2(99.8, -421.7)],
	[Vector2(99.8, -421.7), Vector2(196.9, -421.9)],
	[Vector2(196.9, -421.9), Vector2(320.2, -414.6)],
	[Vector2(320.2, -414.6), Vector2(501.9, -392.0)],
	[Vector2(501.9, -392.0), Vector2(970.8, -509.2)],
	[Vector2(970.8, -509.2), Vector2(998.6, -360.6)],
	[Vector2(998.6, -360.6), Vector2(1087.2, -336.1)],
	[Vector2(1087.2, -336.1), Vector2(1226.1, -300.7)],
	[Vector2(1226.1, -300.7), Vector2(1222.4, -224.0)],
	[Vector2(1222.4, -224.0), Vector2(1064.0, -251.5)],
	[Vector2(1064.0, -251.5), Vector2(993.1, -273.4)],
	[Vector2(993.1, -273.4), Vector2(921.1, -306.5)],
	[Vector2(921.1, -306.5), Vector2(906.8, -343.3)],
	[Vector2(906.8, -343.3), Vector2(839.6, -333.0)],
	[Vector2(839.6, -333.0), Vector2(803.7, -312.6)],
	[Vector2(803.7, -312.6), Vector2(662.1, -305.5)],
	[Vector2(662.1, -305.5), Vector2(597.6, -311.7)],
	[Vector2(597.6, -311.7), Vector2(516.9, -317.6)],
	[Vector2(516.9, -317.6), Vector2(478.7, -299.8)],
	[Vector2(478.7, -299.8), Vector2(383.2, -294.5)],
	[Vector2(383.2, -294.5), Vector2(301.7, -310.9)],
	[Vector2(301.7, -310.9), Vector2(228.2, -313.4)],
	[Vector2(228.2, -313.4), Vector2(134.0, -320.1)],
	[Vector2(134.0, -320.1), Vector2(44.1, -331.4)],
	[Vector2(44.1, -331.4), Vector2(-95.7, -339.9)],
	[Vector2(-95.7, -339.9), Vector2(-195.8, -331.7)],
	[Vector2(-195.8, -331.7), Vector2(-238.9, -290.4)],
	[Vector2(-238.9, -290.4), Vector2(-235.4, -261.3)],
	[Vector2(-235.4, -261.3), Vector2(-286.2, -204.4)],
	[Vector2(-286.2, -204.4), Vector2(-319.8, -225.3)],
	[Vector2(-319.8, -225.3), Vector2(-319.5, -202.6)],
	[Vector2(-319.5, -202.6), Vector2(-306.0, -168.5)],
	[Vector2(-306.0, -168.5), Vector2(-254.7, -128.5)],
	[Vector2(-254.7, -128.5), Vector2(-158.0, -42.9)],
	[Vector2(-158.0, -42.9), Vector2(-177.8, -3.5)],
	[Vector2(-177.8, -3.5), Vector2(-187.1, 28.8)],
	[Vector2(-187.1, 28.8), Vector2(-148.7, 93.9)],
	[Vector2(-148.7, 93.9), Vector2(-141.4, 123.3)],
	[Vector2(-141.4, 123.3), Vector2(-113.9, 139.4)],
	[Vector2(-113.9, 139.4), Vector2(-141.2, 205.5)],
	[Vector2(-141.2, 205.5), Vector2(-115.7, 243.3)],
	[Vector2(-115.7, 243.3), Vector2(-122.3, 338.5)],
	[Vector2(-122.3, 338.5), Vector2(-132.2, 429.6)],
	[Vector2(-132.2, 429.6), Vector2(-93.8, 530.9)],
	[Vector2(-93.8, 530.9), Vector2(-7.2, 580.8)],
	[Vector2(-7.2, 580.8), Vector2(56.1, 660.2)],
	[Vector2(56.1, 660.2), Vector2(100.3, 706.7)],
	[Vector2(100.3, 706.7), Vector2(-10.3, 774.7)],
	[Vector2(-10.3, 774.7), Vector2(-25.6, 810.7)],
	[Vector2(-25.6, 810.7), Vector2(-166.4, 843.7)],
]
