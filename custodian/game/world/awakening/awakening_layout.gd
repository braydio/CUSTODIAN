...
const ZONES: Array[Dictionary] = [
	...
	},
	{
		...
		"envelope": Rect2(-704, -4864, 1408, 1088),
...
const FLOOR_RECTS := {
	...
	&"zone06_undergate": [
		Rect2(-128, -4096, 256, 256),
		Rect2(-512, -4608, 1024, 512),
		Rect2(-160, -4800, 320, 192),
...
const SET_PIECES := {
	...
	&"zone06_undergate": [
		{"id": "drum_west", "label": "GIANT DRUM", "position": Vector2(-400, -4216), "size": Vector2(160, 224), "blocking": true},
		{"id": "drum_east", "label": "GIANT DRUM", "position": Vector2(400, -4216), "size": Vector2(160, 224), "blocking": true},
		{"id": "coil_west", "label": "ROUTE COIL", "position": Vector2(-480, -4496), "size": Vector2(96, 96), "blocking": true},
		{"id": "coil_east", "label": "ROUTE COIL", "position": Vector2(480, -4496), "size": Vector2(96, 96), "blocking": true},
		{"id": "damaged_plinth", "label": "DAMAGED MECHANISM PLINTH", "position": Vector2(128, -4016), "size": Vector2(64, 56), "blocking": true},
		{"id": "housing_wa", "label": "BLIND HOUSING", "position": Vector2(-256, -4000), "size": Vector2(64, 96), "blocking": true},
		{"id": "housing_ea", "label": "BLIND HOUSING", "position": Vector2(256, -4000), "size": Vector2(64, 96), "blocking": true},
		{"id": "housing_wb", "label": "BLIND HOUSING", "position": Vector2(-352, -4544), "size": Vector2(64, 96), "blocking": true},
		{"id": "housing_eb", "label": "BLIND HOUSING", "position": Vector2(352, -4544), "size": Vector2(64, 96), "blocking": true},
