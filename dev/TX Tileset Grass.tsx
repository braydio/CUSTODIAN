...
<tileset version="1.10" tiledversion="1.12.1" name="TX Tileset Grass" tilewidth="32" tileheight="32" tilecount="64" columns="8">
 <image source="../sprites/additional-charsets/Texture/TX Tileset Grass.png" width="256" height="256"/>
 <wangsets>
  <wangset name="grass" type="edge" tile="10">
  ...
  <wangset name="pavers" type="corner" tile="41">
   <wangcolor name="" color="#ff0000" tile="-1" probability="1"/>
   ...
   <wangtile tileid="56" wangid="0,1,0,1,0,0,0,0"/>
   <wangtile tileid="57" wangid="0,0,0,0,0,1,0,1"/>
   <wangtile tileid="58" wangid="0,1,0,0,0,0,0,0"/>
  ...
  <wangset name="grass_alt" type="mixed" tile="27">
   <wangcolor name="" color="#ff0000" tile="-1" probability="1"/>
   ...
   <wangtile tileid="27" wangid="1,1,1,0,0,0,1,1"/>
   <wangtile tileid="28" wangid="1,1,1,0,0,0,1,1"/>
   <wangtile tileid="29" wangid="1,1,1,0,0,0,1,1"/>
   <wangtile tileid="30" wangid="1,1,1,0,0,0,1,1"/>
   <wangtile tileid="31" wangid="1,1,1,0,0,0,1,1"/>
  </wangset>
  <wangset name="4_stone_walkways" type="edge" tile="48">
   <wangcolor name="" color="#ff0000" tile="-1" probability="1"/>
   <wangcolor name="" color="#00ff00" tile="-1" probability="1"/>
   <wangtile tileid="32" wangid="1,0,2,0,2,0,1,0"/>
   <wangtile tileid="33" wangid="2,0,2,0,1,0,1,0"/>
   <wangtile tileid="40" wangid="1,0,1,0,1,0,2,0"/>
   <wangtile tileid="41" wangid="2,0,2,0,2,0,1,0"/>
   <wangtile tileid="48" wangid="2,0,2,0,1,0,1,0"/>
   <wangtile tileid="49" wangid="1,0,2,0,2,0,1,0"/>
   <wangtile tileid="56" wangid="2,0,1,0,2,0,2,0"/>
   <wangtile tileid="57" wangid="2,0,1,0,2,0,2,0"/>
  </wangset>
 </wangsets>
</tileset>
