...
If this primer conflicts with legacy planning docs, trust `ai/*`, `design/*`, and current code.
...
5. Update `design/CHANGELOG.md` and relevant design/ai context docs when behavior changes.
