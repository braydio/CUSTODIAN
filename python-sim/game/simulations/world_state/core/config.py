...
AMBIENT_FAB_BASE_UNITS_PER_TICK = 0.6
AMBIENT_FAB_POWER_LOAD_SOFTCAP = 3.0
AMBIENT_FAB_POWER_LOAD_PENALTY = 0.08
AMBIENT_FAB_SUPPLY_PRESSURE_PENALTY = 0.12
...
ASSAULT_TRANSIT_INTERCEPT_FLOOR = THREAT_MULT_FLOOR
...
# Deterministic grid substrate (Phase 1).
GRID_WIDTH = 12
GRID_HEIGHT = 12
