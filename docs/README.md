...
- `game/simulations/world_state/docs/terminal-repl.md`: Phase 1 terminal loop, `/command` transport contract, command reference (`STATUS`, `WAIT`, `WAIT 10X`, `FOCUS`, `HELP`), and reset flow (`RESET`/`REBOOT`).
